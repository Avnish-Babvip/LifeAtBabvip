            ...
            <div class="row justify-content-center g-4">
              <div class="col-xl-4 col-lg-6">
                <div class="mk-sf-item bg-white">
                  ...
                  <h4 class="mk-heading mb-3 mt-4">Secure Integration</h4>
                  <p class="mb-0">
                    Quickly fabricate customer directed synergy for
                    client-centric users. Globally repurpose granular users
                    without highly efficient solutions.{" "}
                  </p>
                </div>
              </div>
              <div class="col-xl-4 col-lg-6">
                <div class="mk-sf-item bg-white">
                  ...
                  <h4 class="mk-heading mb-3 mt-4">Data Security</h4>
                  <p class="mb-0">
                    Quickly fabricate customer directed synergy for
                    client-centric users. Globally repurpose granular users
                    without highly efficient solutions.{" "}
              ...
              <div class="col-xl-4 col-lg-6">
                <div class="mk-sf-item bg-white">
                  ...
                  <h4 class="mk-heading mb-3 mt-4">No Extra Cost</h4>
                  <p class="mb-0">
                    Quickly fabricate customer directed synergy for
                    client-centric users. Globally repurpose granular users
                    without highly efficient solutions.{" "}
