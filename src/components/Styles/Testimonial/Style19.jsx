...
const Style19 = () => {
  ...
  return (
    <>
    <div class="digi-testimonial ah-bg ptb-60">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center mb-5">
                            ...
                            <h2 class="digi-testimonial-title clr-text">
                    ...
                    <div class="col-lg-7">
                        <div class="position-relative z-3">
                            <div class="swiper digi-testimonial-wrapper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                                <div class="swiper-wrapper" ><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="2" role="group" aria-label="3 / 3" >
                                        <div class="d-md-flex align-items-center digi-testimonial-single border bg-white shadow-lg">
                                            ...
                                            <div>
                                                ...
                                                <span class="fs-sm text-pink-2">Founder &amp; CEO</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="digi-nav-control">
                                <span class="swiper-button-prev shadow-sm" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-21beebf4224a1827"><i class="fas fa-arrow-left"></i></span>
                                <span class="swiper-button-next shadow-sm" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-21beebf4224a1827"><i class="fas fa-arrow-right"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
